...
# 사용법
test.py를 실행하시면 콘솔을 통해 결과값을 확인할 수 있습니다. 
test.py와 statist는 테스트용이며, toobuk디렉토리가 실제 모듈입니다.

## 가장 기본적인 사용법입니다.
statist/house 디렉토리에 보시면 stock.json이라는 파일이 있습니다. 참고하셔서 보세요
아래와 같은 내용이 있습습나다. 크롤링할 url과 bs에서 사용하는 parser가 정의되어 있습니다.
...
소스는 아래와 같습니다. 나름 객체지향을 적용하다보니 좀 복잡해보입니다. 단순히 StockProgress 의 grumble을 보시면 됩니다.
